classdef pos_p2p_f < posstab_f
    ...
    methods
        function obj = pos_p2p_f(traj, param,  data_options)
            %POS_P2P Construct an instance of this class
            %   Detailed explanation goes here
            if nargin < 3
                data_options = data_opts;
            end
            obj@posstab_f(traj, data_options);
...
%             X = diag(vars.y);
            ...
            poly_out = poly_stab@posstab_f(obj, vars);
...
%             con_lyap = 
        ...
        function out = recover(obj, vars, sol)
            out = recover@posstab_f(obj, vars, sol);
